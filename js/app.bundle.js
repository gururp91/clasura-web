 ...
 * Generated at: 2026-09-12T22:13:42.408Z
 * Version: 20260912-221342
 * Modules: 22
 */
...
function renderAgentReport(data) {
  ...
  (d.bacaklar || []).forEach(function(bc) {
    ...
    // Bacak 3 - Hareket Tabloları & Yorumu
    if (bc.no === 3) {
  ...
  if (d.dg_top_picks) {
    ...
    html += '<div class="agent-section">' +
      ...
      '</div>';
    if (TP.kayitlar && TP.kayitlar.length > 0) {
      ...
      html += '<div class="agent-empty-leg"><ion-icon name="information-circle-outline"></ion-icon> ' + esc(TP['not'] || 'DG Top Picks bugün yok.') + '</div>';
    }
    html += '</div>';
  }
