 ...
 * Generated at: 2026-09-15T18:22:07.125Z
 * Version: 20260915-182207
 * Modules: 22
 */
...
function renderAgentReport(data) {
  ...
  // 2. 3 Bacak Kesişimi (Yalnızca veride varsa ve seçim içeriyorsa)
  if (d.kesisim && d.kesisim.secimler && d.kesisim.secimler.length > 0) {
    var k = d.kesisim;
  ...
  // 3. Bacak Önerileri (Meşin Yuvarlak & Macau Pusulası / Agent Macau)
  var ALT_LEG_MAP = {
  ...
  (d.bacaklar || []).forEach(function(bc) {
    ...
    // Hareket Bacağı için: Oranı Düşenler / Yükselenler Tabloları & Yorumu
